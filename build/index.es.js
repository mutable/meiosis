...
var Button = function (_a) {
    ...
    return (React.createElement("button", __assign({ type: "button", className: className }, props), label));
};
...
function Group(_ref) {
  ...
  return /*#__PURE__*/React.createElement("g", _extends$d({
    ref: innerRef,
...
function AreaClosed(_ref) {
  ...
  return /*#__PURE__*/React.createElement("path", _extends$b({
    ref: innerRef,
...
function Bar(_ref) {
  ...
  return /*#__PURE__*/React.createElement("rect", _extends$a({
    ref: innerRef,
...
function GridRows(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Group, {
    ...
    var from = _ref2.from,
        to = _ref2.to;
    return /*#__PURE__*/React.createElement(_default, _extends$8({
      key: "row-line-" + i,
      from: from,
      to: to,
      stroke: stroke,
...
function GridColumns(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Group, {
    ...
    var from = _ref2.from,
        to = _ref2.to;
    return /*#__PURE__*/React.createElement(_default, _extends$7({
      key: "column-line-" + i,
      from: from,
      to: to,
      stroke: stroke,
...
initialTooltipState) {
  var _useState = useState(_extends$6({
    tooltipOpen: false
  }, initialTooltipState)),
...
function withTooltip(BaseComponent, containerProps, renderContainer) {
  ...
  var WrappedComponent = function WrappedComponent(props) {
    ...
    return renderContainer( /*#__PURE__*/React.createElement(BaseComponent, _extends$5({}, tooltipProps, props)), containerProps);
  };
...
var AreaChart = withTooltip(function (_a) {
    ...
    var usageValueScale = useMemo(function () {
    ...
    return (React.createElement("div", null,
        React.createElement("svg", { width: width, height: height },
            React.createElement("rect", { x: 0, y: 0, width: width, height: height, fill: "url(#area-background-gradient)", rx: 14 }),
            React.createElement(LinearGradient, { id: "area-gradient", from: accentColor, to: accentColor }),
            React.createElement(GridRows, { left: margin.left, scale: usageValueScale, width: innerWidth, strokeDasharray: "1,3", stroke: accentColor, strokeOpacity: 0, pointerEvents: "none" }),
            React.createElement(GridColumns, { top: margin.top, scale: dateScale, height: innerHeight, strokeDasharray: "1,3", stroke: accentColor, strokeOpacity: 0.2, pointerEvents: "none" }),
            React.createElement(AreaClosed, { data: data, x: function (d) { var _a; return (_a = dateScale(getDate(d))) !== null && _a !== void 0 ? _a : 0; }, y: function (d) { var _a; return (_a = usageValueScale(getValue(d))) !== null && _a !== void 0 ? _a : 0; }, yScale: usageValueScale, strokeWidth: 1, stroke: "url(#area-gradient)", fill: "url(#area-gradient)", curve: monotoneX }),
            React.createElement(Bar, { x: margin.left, y: margin.top, width: innerWidth, height: innerHeight, fill: "transparent", rx: 14, onTouchStart: handleTooltip, onTouchMove: handleTooltip, onMouseMove: handleTooltip, onMouseLeave: function () { return hideTooltip(); } }),
            tooltipData && (React.createElement("g", null,
                React.createElement(Line$1, { from: { x: tooltipLeft, y: margin.top }, to: { x: tooltipLeft, y: innerHeight + margin.top }, stroke: accentColorDark, strokeWidth: 2, pointerEvents: "none", strokeDasharray: "5,2" })))),
        tooltipData && (React.createElement("div", null,
            React.createElement(TooltipWithBounds$1, { key: Math.random(), top: tooltipTop - 12, left: tooltipLeft + 12, style: tooltipStyles }, getValue(tooltipData).toFixed(2) + " " + unit)))));
});

export { AreaChart, Button };
