...
var Button = function (_a) {
    var _b = _a.primary, primary = _b === void 0 ? false : _b, label = _a.label, props = __rest(_a, ["primary", "label"]);
    ...
    return (React__default['default'].createElement("button", __assign({ type: "button", className: className }, props), label));
};
...
function z(a){if("object"===typeof a&&null!==a){var u=a.$$typeof;switch(u){case c:switch(a=a.type,a){case l:case m:case e:case g:case f:case p:return a;default:switch(a=a&&a.$$typeof,a){case k:case n:case t:case r:case h:return a;default:return u}}case d:return u}}}function A$1(a){return z(a)===m}var AsyncMode=l;var ConcurrentMode=m;var ContextConsumer=k;var ContextProvider=h;var Element$1=c;var ForwardRef=n;var Fragment=e;var Lazy=t;var Memo=r;var Portal=d;
var Profiler=g;var StrictMode=f;var Suspense=p;var isAsyncMode=function(a){return A$1(a)||z(a)===l};var isConcurrentMode=A$1;var isContextConsumer=function(a){return z(a)===k};var isContextProvider=function(a){return z(a)===h};var isElement$1=function(a){return "object"===typeof a&&null!==a&&a.$$typeof===c};var isForwardRef=function(a){return z(a)===n};var isFragment=function(a){return z(a)===e};var isLazy=function(a){return z(a)===t};
...
function Group(_ref) {
  var _ref$top = _ref.top,
      ...
      restProps = _objectWithoutPropertiesLoose$a(_ref, ["top", "left", "transform", "className", "children", "innerRef"]);

  return /*#__PURE__*/React__default['default'].createElement("g", _extends$d({
    ref: innerRef,
...
function Line$1(_ref) {
  var _ref$from = _ref.from,
    ...
    y: 1
      ...
      className = _ref.className,
      innerRef = _ref.innerRef,
      restProps = _objectWithoutPropertiesLoose$9(_ref, ["from", "to", "fill", "className", "innerRef"]);

  var isRectilinear = from.x === to.x || from.y === to.y;
  return /*#__PURE__*/React__default['default'].createElement("line", _extends$c({
    ref: innerRef,
...
function AreaClosed(_ref) {
  var x = _ref.x,
    ...
    return true;
      ...
      innerRef = _ref.innerRef,
      children = _ref.children,
      restProps = _objectWithoutPropertiesLoose$8(_ref, ["x", "x0", "x1", "y", "y1", "y0", "yScale", "data", "defined", "className", "curve", "innerRef", "children"]);
  ...
  if (children) return /*#__PURE__*/React__default['default'].createElement(React__default['default'].Fragment, null, children({
    path: path
  }));
  return /*#__PURE__*/React__default['default'].createElement("path", _extends$b({
    ref: innerRef,
...
function Bar(_ref) {
  var className = _ref.className,
      innerRef = _ref.innerRef,
      restProps = _objectWithoutPropertiesLoose$7(_ref, ["className", "innerRef"]);

  return /*#__PURE__*/React__default['default'].createElement("rect", _extends$a({
    ref: innerRef,
...
function Line(_ref) {
  var _ref$from = _ref.from,
    ...
    y: 1
      ...
      className = _ref.className,
      innerRef = _ref.innerRef,
      restProps = _objectWithoutPropertiesLoose$6(_ref, ["from", "to", "fill", "className", "innerRef"]);

  var isRectilinear = from.x === to.x || from.y === to.y;
  return /*#__PURE__*/_react.default.createElement("line", _extends$9({
    ref: innerRef,
...
var Point = /*#__PURE__*/function () {
  function Point(_ref) {
    ...
    _defineProperty$1(this, "x", 0);

    _defineProperty$1(this, "y", 0);
...
function GridRows(_ref) {
  var _ref$top = _ref.top,
      ...
      restProps = _objectWithoutPropertiesLoose$5(_ref, ["top", "left", "scale", "width", "stroke", "strokeWidth", "strokeDasharray", "className", "children", "numTicks", "lineStyle", "offset", "tickValues"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Group, {
    ...
    var from = _ref2.from,
        to = _ref2.to;
    return /*#__PURE__*/React__default['default'].createElement(_default, _extends$8({
      key: "row-line-" + i,
      from: from,
      to: to,
      stroke: stroke,
...
function GridColumns(_ref) {
  var _ref$top = _ref.top,
      ...
      tickValues = _ref.tickValues,
      children = _ref.children,
      restProps = _objectWithoutPropertiesLoose$4(_ref, ["top", "left", "scale", "height", "stroke", "strokeWidth", "strokeDasharray", "className", "numTicks", "lineStyle", "offset", "tickValues", "children"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement(Group, {
    ...
    var from = _ref2.from,
        to = _ref2.to;
    return /*#__PURE__*/React__default['default'].createElement(_default, _extends$7({
      key: "column-line-" + i,
      from: from,
      to: to,
      stroke: stroke,
...
initialTooltipState) {
  var _useState = React.useState(_extends$6({
    tooltipOpen: false
  }, initialTooltipState)),
  ...
  var showTooltip = React.useCallback(function (showArgs) {
    return setTooltipState(typeof showArgs === 'function' ? function (_ref) {
      _ref.tooltipOpen;
          var show = _objectWithoutPropertiesLoose$3(_ref, ["tooltipOpen"]);

      return _extends$6({}, showArgs(show), {
        tooltipOpen: true
      });
    } : {
      tooltipOpen: true,
...
function withTooltip(BaseComponent, containerProps, renderContainer) {
  ...
  var WrappedComponent = function WrappedComponent(props) {
    ...
    return renderContainer( /*#__PURE__*/React__default['default'].createElement(BaseComponent, _extends$5({}, tooltipProps, props)), containerProps);
  };
...
function Tooltip(_ref) {
  var className = _ref.className,
      ...
      restProps = _objectWithoutPropertiesLoose$2(_ref, ["className", "top", "left", "offsetLeft", "offsetTop", "style", "children", "unstyled", "applyPositionStyle"]);
...
function withBoundingRects(BaseComponent) {
  ...
  return _temp = _class = /*#__PURE__*/function (_React$PureComponent) {
    ...
    return WrappedComponent;
  }(React__default['default'].PureComponent), _defineProperty(_class, "displayName", "withBoundingRects(" + (BaseComponent.displayName || '') + ")"), _temp;
}
...
function TooltipWithBounds(_ref) {
  var children = _ref.children;
      ...
      _ref$unstyled = _ref.unstyled,
      unstyled = _ref$unstyled === void 0 ? false : _ref$unstyled,
      otherProps = _objectWithoutPropertiesLoose$1(_ref, ["children", "getRects", "left", "offsetLeft", "offsetTop", "parentRect", "rect", "style", "top", "unstyled"]);
...
function getXAndYFromEvent(event) {
  if (!event) return _extends$1({}, DEFAULT_POINT);

  if (isTouchEvent(event)) {
    return event.changedTouches.length > 0 ? {
      x: event.changedTouches[0].clientX,
      y: event.changedTouches[0].clientY
    } : _extends$1({}, DEFAULT_POINT);
  }
  ...
  if (!boundingClientRect) return _extends$1({}, DEFAULT_POINT);
  return {
...
function LinearGradient(_ref) {
  ...
  return /*#__PURE__*/React__default['default'].createElement("defs", null, /*#__PURE__*/React__default['default'].createElement("linearGradient", _extends({
    id: id,
    x1: x1,
    y1: y1,
    x2: x2,
  ...
  }, restProps), !!children && children, !children && /*#__PURE__*/React__default['default'].createElement("stop", {
    offset: fromOffset,
    stopColor: from,
    stopOpacity: fromOpacity
  }), !children && /*#__PURE__*/React__default['default'].createElement("stop", {
    offset: toOffset,
    stopColor: to,
...
var accentColor = '#DB2777';
var accentColorDark = '#831843';
var tooltipStyles = __assign(__assign({}, defaultStyles), { background: background, border: '0px solid white', color: 'black' });
// accessors
var getDate = function (d) { return new Date(d.time); };
var getValue = function (d) { return parseFloat(d.value); };
var bisectDate = bisector(function (d) { return new Date(d.time); }).left;
var AreaChart = withTooltip(function (_a) {
    var width = _a.width, height = _a.height, data = _a.data, unit = _a.unit, _b = _a.margin, margin = _b === void 0 ? { top: 0, right: 0, bottom: 0, left: 0 } : _b, showTooltip = _a.showTooltip, hideTooltip = _a.hideTooltip, tooltipData = _a.tooltipData, _c = _a.tooltipTop, tooltipTop = _c === void 0 ? 0 : _c, _d = _a.tooltipLeft, tooltipLeft = _d === void 0 ? 0 : _d;
    if (width < 10)
        return null;
    // bounds
    ...
    // scales
    var dateScale = React.useMemo(function () {
        return createTimeScale({
            range: [margin.left, innerWidth + margin.left],
            domain: extent(data, getDate),
        });
    }, [innerWidth, margin.left]);
    var usageValueScale = React.useMemo(function () {
    ...
    return (React__default['default'].createElement("div", null,
        React__default['default'].createElement("svg", { width: width, height: height },
            React__default['default'].createElement("rect", { x: 0, y: 0, width: width, height: height, fill: "url(#area-background-gradient)", rx: 14 }),
            React__default['default'].createElement(LinearGradient, { id: "area-gradient", from: accentColor, to: accentColor }),
            React__default['default'].createElement(GridRows, { left: margin.left, scale: usageValueScale, width: innerWidth, strokeDasharray: "1,3", stroke: accentColor, strokeOpacity: 0, pointerEvents: "none" }),
            React__default['default'].createElement(GridColumns, { top: margin.top, scale: dateScale, height: innerHeight, strokeDasharray: "1,3", stroke: accentColor, strokeOpacity: 0.2, pointerEvents: "none" }),
            React__default['default'].createElement(AreaClosed, { data: data, x: function (d) { var _a; return (_a = dateScale(getDate(d))) !== null && _a !== void 0 ? _a : 0; }, y: function (d) { var _a; return (_a = usageValueScale(getValue(d))) !== null && _a !== void 0 ? _a : 0; }, yScale: usageValueScale, strokeWidth: 1, stroke: "url(#area-gradient)", fill: "url(#area-gradient)", curve: monotoneX }),
            React__default['default'].createElement(Bar, { x: margin.left, y: margin.top, width: innerWidth, height: innerHeight, fill: "transparent", rx: 14, onTouchStart: handleTooltip, onTouchMove: handleTooltip, onMouseMove: handleTooltip, onMouseLeave: function () { return hideTooltip(); } }),
            tooltipData && (React__default['default'].createElement("g", null,
                React__default['default'].createElement(Line$1, { from: { x: tooltipLeft, y: margin.top }, to: { x: tooltipLeft, y: innerHeight + margin.top }, stroke: accentColorDark, strokeWidth: 2, pointerEvents: "none", strokeDasharray: "5,2" })))),
        tooltipData && (React__default['default'].createElement("div", null,
            React__default['default'].createElement(TooltipWithBounds$1, { key: Math.random(), top: tooltipTop - 12, left: tooltipLeft + 12, style: tooltipStyles }, getValue(tooltipData).toFixed(2) + " " + unit)))));
});
